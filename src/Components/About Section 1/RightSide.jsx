...
import rightImg from '../../assets/Right SIde Image.png';
...
function RightSide() {
  ...
  >
    ...
    flexDirection={['column'  , 'column' , 'column' , 'row-reverse' , 'row-reverse']} >
      {/* Image */}
      <HStack 
      ...
      position={'relative'}>
        ...
        >
          <Image width={'100%'} height={'100%'} objectFit={'cover'} boxSize={'80%'} src={rightImg} />
        </HStack>
      </HStack>
